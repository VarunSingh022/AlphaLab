...
class WorkbenchEngine:
    ...
    @staticmethod
    def open_project(
        wb_state: WorkbenchState, project_id: str, ts: float
    ) -> WorkbenchState:
    ...
    @staticmethod
    def open_dataset(
        wb_state: WorkbenchState, dataset_id: str, ts: float
    ) -> WorkbenchState:
    ...
    @staticmethod
    def show_report(
        wb_state: WorkbenchState, report_id: str, ts: float
    ) -> WorkbenchState:
        return WorkbenchManager.open_tab(
    ...
    @staticmethod
    def restore_layout(
        wb_state: WorkbenchState, layout_id: str, ts: float
    ) -> WorkbenchState:
    ...
    def run_backtest(
        ...
        result_events = [
            e
            for e in new_studio_state.events
            if type(e).__name__ == "BacktestCompleted"
        ]
    ...
    def run_pipeline(
        ...
        result_events = [
            e
            for e in new_studio_state.events
            if type(e).__name__ == "PipelineExecuted"
        ]
