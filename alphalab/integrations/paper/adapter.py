"""Paper Provider Adapter."""

from typing import Any

from alphalab.integrations.paper.client import PaperBrokerClient
from alphalab.integrations.paper.config import PaperConfig


class PaperAdapter:
    """Thin adapter mapping AlphaLab requests to the Paper client."""

    __slots__ = ("_client", "_config")

    def __init__(self, config: PaperConfig) -> None:
        self._config = config
        self._client = PaperBrokerClient()
